...
The last verified functional code baseline is `e1a50741580379f0f65c80e212f04c449e5a8c9b`; PR #16 is its still-unmerged review record, and `26770254618189d693ad9553d92bcba896a8b81b` is a diagnostic-label-only descendant. Live `main` remains the M3.1 squash merge `01a64f8e35ccce53702f55db6d750572a1b96e6a` until PR #16 receives explicit merge authorization. M3.2's pinned generated interop and zero-string budgeted Control View snapshot are runtime accepted under ADR 0008. After merge, the next branch is `dev/m3-3-semantic-ui-snapshot`; begin with a separate `ReadUiText` privacy/content-bounds contract, not live or unbounded text extraction. Resolve live Git/PR state, then compare it with `docs/PROJECT_STATE.md` before working.
