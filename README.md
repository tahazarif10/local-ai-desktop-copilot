...
| Automated tests / CI | M2.4.1 defines 43 deterministic core characterization tests plus Linux-test and Windows-test/build CI jobs; acceptance depends on the latest recorded run |
