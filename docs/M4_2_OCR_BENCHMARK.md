...
The setup uses Python Install Manager `py install --target` to place Python 3.12 below ignored `.localcopilot/ocr-benchmark`. It does not replace, unregister, or modify the existing Python 3.14 installation.
